const YandexMap = ({type}: {type: 'house' | "street"}) => {
  return (
    type === "house" ? (
    <div style={{ position: "relative", overflow: "hidden", width: "100%" }}>
      ...
      <iframe
        src="https://yandex.ru/map-widget/v1/?display-text=%D0%97%D0%90%D0%93%D0%A1&ll=38.918414%2C47.215257&mode=search&oid=177769129752&ol=biz&sll=38.936699%2C47.208735&sspn=0.072784%2C0.090190&text=%7B%22text%22%3A%22%D0%97%D0%90%D0%93%D0%A1%22%2C%22what%22%3A%5B%7B%22attr_name%22%3A%22category_id%22%2C%22attr_values%22%3A%5B%22184107242%22%5D%7D%5D%7D&z=15"
        width="560"
        height="400"
        frameBorder="1"
        allowFullScreen
        style={{ position: "relative" }}
        title="Yandex Map - ЗАГС Таганрог"
      />
    </div>
    )
